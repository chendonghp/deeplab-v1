...
class VGG16_LargeFOV():
    def __init__(self, num_classes, init_weights=False, ignore_index=-100, gpu_id=0, print_freq=10, epoch_print=10):
    ...
    def train(self, train_data, test_data, save=True, epochs=74, lr=0.01, momentum=0.9, weight_decay=0.0005):
